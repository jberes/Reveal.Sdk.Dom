...
namespace Reveal.Sdk.Dom.Visualizations
{
    ...
    public sealed class StepAreaChartVisualization : CategoryVisualizationBase<StepAreaChartVisualizationSettings>
    {
        ...
        public StepAreaChartVisualization(DataSourceItem dataSourceItem) : this(null, dataSourceItem) { }
        ...
        /// <param name="dataSourceItem">The data soure item used to represent a dataset.</param>
        public StepAreaChartVisualization(string title, DataSourceItem dataSourceItem) : base(title, dataSourceItem) { ChartType = ChartType.StepArea; }
    }
}

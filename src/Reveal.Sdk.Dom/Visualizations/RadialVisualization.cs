...
namespace Reveal.Sdk.Dom.Visualizations
{
    ...
    public sealed class RadialVisualization : CategoryVisualizationBase<RadialVisualizationSettings>
    {
        ...
        public RadialVisualization(DataSourceItem dataSourceItem) : this(null, dataSourceItem) { }
        ...
        /// <param name="dataSourceItem">The data soure item used to represent a dataset.</param>
        public RadialVisualization(string title, DataSourceItem dataSourceItem) : base(title, dataSourceItem) { ChartType = ChartType.Radial; }
    }
}

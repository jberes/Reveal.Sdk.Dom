namespace Reveal.Sdk.Dom.Core.Constants
{
    public static class AvailableMaps
    {
        ...
        {
            public const string AllAsia = "Asia";
        ...
        {
            public const string AllNorthAmerica = "North America";

            public static class UnitedStates
            {
                public const string Regions = "USA Regions";
                public const string Counties = "USA Counties";

                public static class States
                {
                    public const string AllStates = "USA States";
        ...
        public static class OtherRegions
        {
            public const string APAC = "WO_APAC";
            public const string EMEA = "WO_EMEA";
            public const string Americas = "WO_Americas";
            public const string Japan = "WO_Japan";
            public const string India = "WO_India";
